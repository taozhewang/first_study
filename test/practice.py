...
def print_board(board, player, pointer):
    for row in range(np.size(board, 0)):
        if player == 1 and row == pointer[0]:
            print(' ' * (pointer[1] * 4), chr(9661), sep = '')
            for column in board[row]:
                if column == 0:
                    print(chr(9723), sep = '', end = ' ' * 3)
                elif column == 1:
                    print(chr(1093), sep = '', end = ' ' * 3)
                elif column == 2:
                    print(chr(916), sep = '', end = ' ' * 3)
                elif column == 3:
                    print(chr(1044), sep = '', end = ' ' * 3)
                else:
                    print(chr(8776), sep = '', end = ' ' * 3)
            print('\n')
